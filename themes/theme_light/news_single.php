...
<div class="col-12 col-lg-8 mt-3">
          ...
          <div class="card">
            <div class="card-body">
                <h1 class="card-title fw-bold shadow"><?php echo $News['post_title'];?></h1>
           
                <span  style="font-family:trebuchet ms,sans-serif;font-size: large;">
				<?php echo $News['post_content']; ?>
				</span>
        <p class="blog-post card-text p-4 mb-3 bg-light rounded">
				<?php echo $News['read_more']; ?></p>
                <p class="blog-post card-text p-4 mb-3 bg-light rounded">
				<?php echo $News['created']; ?></p>
