    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mt-3">
                ...
                <p class="text-right h5"><i class="fa fa-heart"></i><a href="<?php echo base_url(); ?>"> العنوان : نهج شابور محمد  - ملكية ورتة رميتة عمار- بالقل </a> الهاتف : <span>213&nbsp;657092671+</span></p>
